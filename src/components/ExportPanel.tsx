...
export const ExportPanel: React.FC<ExportPanelProps> = ({
  ...
  return (
    <div className="bg-white/10 backdrop-blur-md rounded-lg p-6 shadow-xl">
      <h2 className="text-2xl font-bold text-white mb-4">Export & Share</h2>
      ...
      <div className="mb-6">
        ...
        <button
          ...
          className="w-full py-2 px-4 bg-purple-600 hover:bg-purple-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white rounded-lg transition-colors text-sm flex items-center justify-center gap-2"
        >
          {isExporting ? (
            <>
      ...
      <div>
        ...
        {showShareURL && (
          <div className="mt-2 p-2 bg-green-500/20 border border-green-500/50 rounded text-sm text-green-400 text-center">
