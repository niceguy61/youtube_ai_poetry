...
export const AudioPlayer: React.FC<AudioPlayerProps> = ({
  ...
  return (
    <div className={`bg-white/10 backdrop-blur-md rounded-lg p-6 shadow-xl ${className}`}>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            style={{
              background: `linear-gradient(to right, #9333ea 0%, #9333ea ${volume * 100}%, rgba(255,255,255,0.2) ${volume * 100}%, rgba(255,255,255,0.2) 100%)`
            }}
          />
